...
const mock = [
  ...
  new Service(5, 'Serviço Indisponivel', require('../assets/favicon.png'), 'Uma longa descrição', '[Serviço não implementado]'),
  new Service(6, 'Serviço Indisponivel', require('../assets/favicon.png'), 'Uma longa descrição', '[Serviço não implementado]'),
];
